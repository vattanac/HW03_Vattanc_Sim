...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        arraylist = [cellData(cell: 1, imageProfile: #imageLiteral(resourceName: "crush"), userName: "Bopha Toy", postImage:nil, des: "hello world", privatcyIcon: #imageLiteral(resourceName: "public"),likeAmount:243,commentAmount:430,shareAmount:455,hour:2,location:"· Takéo ·"),
                     
                     cellData(cell: 1, imageProfile: #imageLiteral(resourceName: "v"), userName: "Vattanac Sim", postImage:nil, des: "This my homework", privatcyIcon: #imageLiteral(resourceName: "key"),likeAmount:500,commentAmount:430,shareAmount:455,hour:4,location:"· Kondal ·"),
                     ...
                     cellData(cell: 1, imageProfile: #imageLiteral(resourceName: "v"), userName: "Vattanac Sim", postImage:nil, des: "This my homework", privatcyIcon: #imageLiteral(resourceName: "public"),likeAmount:554,commentAmount:168,shareAmount:455,hour:16,location:"· kompot ·"),
                     cellData(cell: 2, imageProfile: #imageLiteral(resourceName: "v"), userName: "Vattanac Sim", postImage:#imageLiteral(resourceName: "vot"), des: "Firebase gives you the tools to develop high-quality apps, grow your user base, and earn more money. We cover the essentials so you can monetize your business and focus on your users.", privatcyIcon: #imageLiteral(resourceName: "acc"),likeAmount:19,commentAmount:30,shareAmount:455,hour:13,location:"· koh kong ·"),
                      cellData(cell: 1, imageProfile: #imageLiteral(resourceName: "crush"), userName: "Bopha Toy", postImage:nil, des: "This my homework", privatcyIcon: #imageLiteral(resourceName: "public"),likeAmount:500,commentAmount:788,shareAmount:455,hour:23,location:"· kep ·")
        ]
